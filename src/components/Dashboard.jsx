      ...
      const fetchTaskData = async () => {
        ...
        if (docSnap.exists()) {
          ...
          const initialTasks = [
            ...
            "কমপক্ষে ৩ পৃষ্ঠা কুরআন তেলাওয়াত করেছি",
            ...
            "দোয়া করেছি",
            "দান করছি ",
            "সোশ্যাল মিডিয়া কম ব্যবহার করেছি  ",
            "কাউকে ইফতার করিয়েছি  ",
          ].map((task) => ({
            name: task,
            days: Array.from({ length: 30 }, () => false), // Initialize all days as false
          }));
          await setDoc(docRef, { tasks: initialTasks, initialTasks: initialTasks });
